...
sudo apt install -y git cmake g++ libffi-dev libncurses-dev libreadline-dev \
libgdbm-dev libssl-dev tcl-dev libsqlite3-dev liblzma-dev lzma-dev uuid-dev \
libbz2-dev tk8.6-dev libgdbm-compat-dev ||
